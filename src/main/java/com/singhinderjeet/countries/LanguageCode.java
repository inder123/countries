...
public enum LanguageCode {
    ...
    sq_AL("Albanian (AL)", CountryCode.AL, LanguageScript.Latn),
    ...
    be_BY("Belarusian (BY)", CountryCode.BY, LanguageScript.Cyrl),
    bg_BG("Bulgarian (BG)", CountryCode.BG, LanguageScript.Cyrl),
    ca_ES("Catalan (ES)", CountryCode.ES, LanguageScript.Latn),
    ...
    cs_CZ("Czech (CZ)", CountryCode.CZ, LanguageScript.Latn),
    da_DK("Danish (DK)", CountryCode.DK, LanguageScript.Latn),
    ...
    et_EE("Estonian (EE)", CountryCode.EE, LanguageScript.Latn),
    ...
    iw_IL("Hebrew (IL)", CountryCode.IL, LanguageScript.Hebr),
    hi_IN("Hindi (IN)", CountryCode.IN, LanguageScript.Deva),
    hu_HU("Hungarian (HU)", CountryCode.HU, LanguageScript.Latn),
    is_IS("Icelandic (IS)", CountryCode.IS, LanguageScript.Latn),
    in_ID("Indonesian (ID)", CountryCode.ID, LanguageScript.Latn),
    ga_IE("Irish (IE)", CountryCode.IE, LanguageScript.Latn),
    ...
    ko_KR("Korean (KR)", CountryCode.KR, LanguageScript.Kore),
    ...
    ms_MY("Malay (MY)", CountryCode.MY, LanguageScript.Latn),
    mt_MT("Maltese (MT)", CountryCode.MT, LanguageScript.Latn),
    no_NO("Norwegian (NO)", CountryCode.NO, LanguageScript.Latn),
    nb_NO("Norwegian Bokmål (NO)", CountryCode.NO, LanguageScript.Latn),
    nn_NO("Norwegian Nynorsk (NO)", CountryCode.NO, LanguageScript.Latn),
    ...
    sl_SI("Slovenian (SI)", CountryCode.SI, LanguageScript.Latn),
    ...
    sv_SE("Swedish (SE)", CountryCode.SE, LanguageScript.Latn),
    ...
    uk_UA("Ukrainian (UA)", CountryCode.UA, LanguageScript.Cyrl),
    vi_VN("Vietnamese (VN)", CountryCode.VN, LanguageScript.Latn);
